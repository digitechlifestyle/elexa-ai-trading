...
const groups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/heikin-ashi", label: "Heikin-Ashi", icon: "🕯️" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/ath-distance", label: "ATH Distance", icon: "🎯" },
      ...
      { href: "/dashboard/sector-ladder", label: "Sector Ladder", icon: "🪜" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/btc-cycle", label: "BTC Cycle", icon: "₿" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/portfolio-health", label: "Health Score", icon: "💯" },
      { href: "/dashboard/goal", label: "Goal Tracker", icon: "🎯" },
      ...
      { href: "/dashboard/allocator", label: "Allocator", icon: "⚖️" },
      { href: "/dashboard/tax-harvest", label: "Tax Harvest", icon: "🧾" },
      { href: "/dashboard/wash-sales", label: "Wash Sale Check", icon: "🧾" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/currency-strength", label: "Currency Strength", icon: "💱" },
    ],
  },
  {
    title: "Backtest",
