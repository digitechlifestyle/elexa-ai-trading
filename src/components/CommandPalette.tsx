...
const COMMANDS: Command[] = [
  ...
  { label: "Market Breadth", href: "/dashboard/market-breadth", icon: "🫁", keywords: "advance decline breadth participation" },
  ...
  { label: "Hurst Exponent", href: "/dashboard/hurst", icon: "🔬", keywords: "hurst regime trending mean reverting fractal" },
  ...
  { label: "Export CSV", href: "/dashboard/export", icon: "📤", keywords: "export download csv trades journal" },
  ...
  { label: "Symbol Compare", href: "/dashboard/symbol-compare", icon: "📊", keywords: "compare overlay relative performance normalised" },
  { label: "P&L Calendar", href: "/dashboard/pnl-calendar", icon: "📅", keywords: "pnl calendar heatmap daily yearly" },
  { label: "Crypto Ratios", href: "/dashboard/crypto-ratios", icon: "🪙", keywords: "eth btc ratio alt season dominance" },
  { label: "Strategy Templates", href: "/dashboard/strategy-templates", icon: "📚", keywords: "strategy template preset rules golden cross turtle bollinger" },
  { label: "AI Setup Scanner", href: "/dashboard/ai-setup-scan", icon: "🤖", keywords: "ai setup scanner claude rank trade quality" },
  { label: "Alpaca Account", href: "/dashboard/account", icon: "🏦", keywords: "alpaca account paper equity buying power positions" },
  { label: "Currency Strength", href: "/dashboard/currency-strength", icon: "💱", keywords: "currency strength forex dxy eur usd gbp jpy" },
  { label: "Portfolio Allocator", href: "/dashboard/allocator", icon: "⚖️", keywords: "allocator weights equal inverse vol sharpe risk parity" },
  { label: "ATH Distance", href: "/dashboard/ath-distance", icon: "🎯", keywords: "ath all time high pullback distance scanner" },
  { label: "Sector Ladder", href: "/dashboard/sector-ladder", icon: "🪜", keywords: "sector etf rotation ladder xlk xlf xle" },
  { label: "BTC Cycle", href: "/dashboard/btc-cycle", icon: "₿", keywords: "bitcoin cycle halving countdown blocks reward" },
  { label: "Position Treemap", href: "/dashboard/position-treemap", icon: "🗺️", keywords: "treemap position visual size weight" },
  ...
  { label: "Health Score", href: "/dashboard/portfolio-health", icon: "💯", keywords: "portfolio health score composite grade" },
  { label: "Goal Tracker", href: "/dashboard/goal", icon: "🎯", keywords: "goal target return progress deadline" },
  { label: "Audit Log", href: "/dashboard/audit", icon: "📜", keywords: "audit log activity history events" },
